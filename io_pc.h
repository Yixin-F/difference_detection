...
pcl::PointCloud<pcl::PointXYZRGB>::Ptr detect(const pcl::PointCloud<pcl::PointXYZI>::Ptr& local_, const pcl::PointCloud<pcl::PointXYZI>::Ptr& global_, const float& search_dis_){
    ...
    pcl::PointCloud<pcl::PointXYZI>::Ptr global_select(new pcl::PointCloud<pcl::PointXYZI>());
    for(size_t i = 0; i < global_num; i ++){
        pcl::PointXYZI pt = global_->points[i];
